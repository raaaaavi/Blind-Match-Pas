...
## Docker SQL Server On Mac

If you are running on macOS and want SQL Server locally, use Docker.

1. Install Docker Desktop for Mac.
2. From the project root, start SQL Server:

```bash
docker compose up -d
```

3. The development config is already prepared to connect to the Docker container using:

```text
Server=localhost,1433;Database=BlindMatchPASDb_Dev;User Id=sa;Password=Your_password123!
```
...
6. To remove the database volume completely:
